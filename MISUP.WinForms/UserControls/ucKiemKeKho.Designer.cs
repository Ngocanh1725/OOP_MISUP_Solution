...
namespace MISUP.WinForms
{
    partial class ucKiemKeKho
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.Text = "Kiểm Kê & Cân Bằng Kho";
            ...
            this.btnThem.Font = new Font("Segoe UI", 10F, FontStyle.Bold); this.btnThem.Text = "📋 Tạo phiếu kiểm kê"; this.btnThem.Size = new Size(180, 35); this.btnThem.Location = new Point(20, 15); this.btnThem.Cursor = Cursors.Hand;
            ...
            this.cmbTrangThai.Size = new Size(160, 32); this.cmbTrangThai.Location = new Point(220, 16);

            this.txtTimKiem.Font = new Font("Segoe UI", 11F); this.txtTimKiem.Size = new Size(250, 32); this.txtTimKiem.Location = new Point(390, 16); this.txtTimKiem.Text = "Tìm mã phiếu..."; this.txtTimKiem.ForeColor = Color.Gray;
            ...
            this.btnTim.Font = new Font("Segoe UI", 10F, FontStyle.Bold); this.btnTim.Text = "Tìm"; this.btnTim.Size = new Size(70, 33); this.btnTim.Location = new Point(650, 15); this.btnTim.Cursor = Cursors.Hand;
            ...
            this.Controls.Add(this.dgvData); this.Controls.Add(this.pnlToolbar); this.Controls.Add(this.pnlHeader); this.Name = "ucKiemKeKho"; this.Size = new Size(1120, 740);
