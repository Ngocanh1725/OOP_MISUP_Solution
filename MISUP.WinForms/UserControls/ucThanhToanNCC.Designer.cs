...
namespace MISUP.WinForms
{
    partial class ucThanhToanNCC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.AutoSize = true; this.lblTitle.Font = new Font("Segoe UI", 18F, FontStyle.Bold); this.lblTitle.ForeColor = Color.FromArgb(41, 56, 70); this.lblTitle.Location = new Point(20, 15); this.lblTitle.Text = "Quản Lý Công Nợ & Thanh Toán";

            this.pnlToolbar.BackColor = Color.FromArgb(245, 246, 250); this.pnlToolbar.Controls.Add(this.btnLapPhieuChi); this.pnlToolbar.Controls.Add(this.txtTimKiem); this.pnlToolbar.Controls.Add(this.btnTim); this.pnlToolbar.Dock = DockStyle.Top; this.pnlToolbar.Height = 65; this.pnlToolbar.Padding = new Padding(20, 15, 20, 15);

            this.btnLapPhieuChi.BackColor = Color.FromArgb(243, 156, 18); this.btnLapPhieuChi.ForeColor = Color.White; this.btnLapPhieuChi.FlatStyle = FlatStyle.Flat; this.btnLapPhieuChi.FlatAppearance.BorderSize = 0; this.btnLapPhieuChi.Font = new Font("Segoe UI", 10F, FontStyle.Bold); this.btnLapPhieuChi.Text = "💸 Lập phiếu chi"; this.btnLapPhieuChi.Size = new Size(150, 35); this.btnLapPhieuChi.Location = new Point(20, 15); this.btnLapPhieuChi.Cursor = Cursors.Hand;
            this.txtTimKiem.Font = new Font("Segoe UI", 11F); this.txtTimKiem.Size = new Size(300, 32); this.txtTimKiem.Location = new Point(190, 16); this.txtTimKiem.Text = "Tìm theo mã phiếu chi..."; this.txtTimKiem.ForeColor = Color.Gray;
            ...
            this.Controls.Add(this.dgvData); this.Controls.Add(this.pnlToolbar); this.Controls.Add(this.pnlHeader); this.Name = "ucThanhToanNCC"; this.Size = new Size(1120, 740);
